...
namespace App\Filament\TaxoParkAdmin\Pages;
...
class TaxoParkAdminDashboard extends Page
{
    protected static string $routePath = '/';

    protected static ?int $navigationSort = -2;

    protected static string $routeName = 'filament.taxoParkAdmin.pages.dashboard';
